...
export interface FdcHubMockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface FdcHubMock extends BaseContract {
  connect(runner?: ContractRunner | null): FdcHubMock;
  waitForDeployment(): Promise<this>;

  interface: FdcHubMockInterface;
