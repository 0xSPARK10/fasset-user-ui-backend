...
export interface FdcVerificationMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "fdcProtocolId"
      | "relay"
...
export interface FdcVerificationMock extends BaseContract {
  connect(runner?: ContractRunner | null): FdcVerificationMock;
  waitForDeployment(): Promise<this>;

  interface: FdcVerificationMockInterface;
