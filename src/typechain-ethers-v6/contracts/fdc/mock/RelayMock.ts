...
export interface RelayMockInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "signingPolicySetter",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "stateData", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "stateData", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "toSigningPolicyHash",
    data: BytesLike
  ): Result;
...
export interface RelayMock extends BaseContract {
  connect(runner?: ContractRunner | null): RelayMock;
  waitForDeployment(): Promise<this>;

  interface: RelayMockInterface;
  ...
  signingPolicySetter: TypedContractMethod<[], [string], "view">;
  ...
  stateData: TypedContractMethod<
    ...
    [
      [
        ...
        randomNumberProtocolId: bigint;
        firstVotingRoundStartTs: bigint;
        votingEpochDurationSeconds: bigint;
        firstRewardEpochStartVotingRoundId: bigint;
        rewardEpochDurationInVotingEpochs: bigint;
        thresholdIncreaseBIPS: bigint;
        randomVotingRoundId: bigint;
        isSecureRandom: boolean;
        lastInitializedRewardEpoch: bigint;
        noSigningPolicyRelay: boolean;
        messageFinalizationWindowInRewardEpochs: bigint;
      }
    ],
    "view"
  >;
