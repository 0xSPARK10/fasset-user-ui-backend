...
export interface FdcRequestFeeConfigurationsMockInterface extends Interface {
...
export interface FdcRequestFeeConfigurationsMock extends BaseContract {
  connect(runner?: ContractRunner | null): FdcRequestFeeConfigurationsMock;
  waitForDeployment(): Promise<this>;

  interface: FdcRequestFeeConfigurationsMockInterface;
  ...
  getRequestFee: TypedContractMethod<[arg0: BytesLike], [bigint], "view">;
