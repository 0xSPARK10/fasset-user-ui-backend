...
export interface GovernedMockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface GovernedMock extends BaseContract {
  connect(runner?: ContractRunner | null): GovernedMock;
