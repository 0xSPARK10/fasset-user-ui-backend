...
export interface IGovernedInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IGoverned extends BaseContract {
  connect(runner?: ContractRunner | null): IGoverned;
  waitForDeployment(): Promise<this>;

  interface: IGovernedInterface;
