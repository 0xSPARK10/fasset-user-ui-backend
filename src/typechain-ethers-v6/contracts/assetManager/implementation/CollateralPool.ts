...
export interface CollateralPoolInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: "donateNat", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "donateNat", data: BytesLike): Result;
...
export interface CollateralPool extends BaseContract {
  ...
  donateNat: TypedContractMethod<[], [void], "payable">;
