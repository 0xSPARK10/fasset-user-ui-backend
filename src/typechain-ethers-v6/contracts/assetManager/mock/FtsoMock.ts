...
export interface FtsoMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activateFtso"
      | "active"
...
export interface FtsoMock extends BaseContract {
  connect(runner?: ContractRunner | null): FtsoMock;
  waitForDeployment(): Promise<this>;

  interface: FtsoMockInterface;
  ...
  setCurrentPrice: TypedContractMethod<
    [_price: BigNumberish, _ageSeconds: BigNumberish],
    [void],
    "nonpayable"
  >;
