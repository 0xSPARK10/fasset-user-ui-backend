...
export interface FtsoRegistryMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addFtso"
      | "getAllCurrentPrices"
...
export interface FtsoRegistryMock extends BaseContract {
  connect(runner?: ContractRunner | null): FtsoRegistryMock;
  waitForDeployment(): Promise<this>;

  interface: FtsoRegistryMockInterface;
