...
export interface MaliciousRewardManagerInterface extends Interface {
...
export interface MaliciousRewardManager extends BaseContract {
  connect(runner?: ContractRunner | null): MaliciousRewardManager;
  waitForDeployment(): Promise<this>;

  interface: MaliciousRewardManagerInterface;
