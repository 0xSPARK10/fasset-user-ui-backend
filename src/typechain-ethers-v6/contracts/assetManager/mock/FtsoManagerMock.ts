...
export interface FtsoManagerMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "active"
  ...
  encodeFunctionData(
    functionFragment: "mockFinalizePriceEpoch",
    values?: undefined
  ): string;
...
export interface FtsoManagerMock extends BaseContract {
  connect(runner?: ContractRunner | null): FtsoManagerMock;
  ...
  mockFinalizePriceEpoch: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "mockFinalizePriceEpoch"
