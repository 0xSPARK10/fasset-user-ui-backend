...
export interface ICollateralPoolFactoryInterface extends Interface {
  getFunction(
...
export interface ICollateralPoolFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ICollateralPoolFactory;
  waitForDeployment(): Promise<this>;

  interface: ICollateralPoolFactoryInterface;
