...
export interface IIAssetManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IIAssetManager extends BaseContract {
  connect(runner?: ContractRunner | null): IIAssetManager;
  waitForDeployment(): Promise<this>;

  interface: IIAssetManagerInterface;
