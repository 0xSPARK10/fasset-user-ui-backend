...
export interface IICollateralPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "agentVault"
      | "assetManager"
...
export interface IICollateralPool extends BaseContract {
  connect(runner?: ContractRunner | null): IICollateralPool;
  waitForDeployment(): Promise<this>;

  interface: IICollateralPoolInterface;
