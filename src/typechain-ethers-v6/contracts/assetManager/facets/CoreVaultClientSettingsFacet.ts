...
export interface CoreVaultClientSettingsFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface CoreVaultClientSettingsFacet extends BaseContract {
  connect(runner?: ContractRunner | null): CoreVaultClientSettingsFacet;
  waitForDeployment(): Promise<this>;

  interface: CoreVaultClientSettingsFacetInterface;
