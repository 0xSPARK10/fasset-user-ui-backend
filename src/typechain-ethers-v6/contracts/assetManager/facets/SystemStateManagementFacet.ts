...
export interface SystemStateManagementFacetInterface extends Interface {
  getFunction(
    nameOrSignature: "attachController" | "pauseMinting" | "unpauseMinting"
  ): FunctionFragment;
...
export interface SystemStateManagementFacet extends BaseContract {
  connect(runner?: ContractRunner | null): SystemStateManagementFacet;
  waitForDeployment(): Promise<this>;

  interface: SystemStateManagementFacetInterface;
