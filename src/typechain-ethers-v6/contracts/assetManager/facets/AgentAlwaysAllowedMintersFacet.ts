...
export interface AgentAlwaysAllowedMintersFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AgentAlwaysAllowedMintersFacet extends BaseContract {
  connect(runner?: ContractRunner | null): AgentAlwaysAllowedMintersFacet;
  waitForDeployment(): Promise<this>;

  interface: AgentAlwaysAllowedMintersFacetInterface;
