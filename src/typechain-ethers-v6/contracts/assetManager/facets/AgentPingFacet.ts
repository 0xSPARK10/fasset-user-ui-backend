...
export interface AgentPingFacetInterface extends Interface {
  getFunction(
...
export interface AgentPingFacet extends BaseContract {
  connect(runner?: ContractRunner | null): AgentPingFacet;
  waitForDeployment(): Promise<this>;

  interface: AgentPingFacetInterface;
