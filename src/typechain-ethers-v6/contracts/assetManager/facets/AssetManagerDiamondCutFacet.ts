...
export interface AssetManagerDiamondCutFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface AssetManagerDiamondCutFacet extends BaseContract {
  connect(runner?: ContractRunner | null): AssetManagerDiamondCutFacet;
  waitForDeployment(): Promise<this>;

  interface: AssetManagerDiamondCutFacetInterface;
