...
export interface CoreVaultFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface CoreVaultFacet extends BaseContract {
  connect(runner?: ContractRunner | null): CoreVaultFacet;
  waitForDeployment(): Promise<this>;

  interface: CoreVaultFacetInterface;
