...
export interface SettingsManagementFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SettingsManagementFacet extends BaseContract {
  connect(runner?: ContractRunner | null): SettingsManagementFacet;
  waitForDeployment(): Promise<this>;

  interface: SettingsManagementFacetInterface;
