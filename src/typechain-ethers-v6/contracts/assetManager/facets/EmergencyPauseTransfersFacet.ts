...
export interface EmergencyPauseTransfersFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface EmergencyPauseTransfersFacet extends BaseContract {
  connect(runner?: ContractRunner | null): EmergencyPauseTransfersFacet;
  waitForDeployment(): Promise<this>;

  interface: EmergencyPauseTransfersFacetInterface;
