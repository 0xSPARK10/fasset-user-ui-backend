...
export interface EmergencyPauseFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "emergencyPause"
...
export interface EmergencyPauseFacet extends BaseContract {
  connect(runner?: ContractRunner | null): EmergencyPauseFacet;
  ...
  emergencyPause: TypedContractMethod<
    [_level: BigNumberish, _governancePause: boolean, _duration: BigNumberish],
    [void],
    "nonpayable"
  >;
