...
export interface DirectMintingFacetInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface DirectMintingFacet extends BaseContract {
  connect(runner?: ContractRunner | null): DirectMintingFacet;
  waitForDeployment(): Promise<this>;

  interface: DirectMintingFacetInterface;
