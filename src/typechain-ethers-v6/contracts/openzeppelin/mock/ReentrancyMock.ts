...
export interface ReentrancyMockInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "unguardedMethodThatShouldFail",
    values?: undefined
  ): string;
...
export interface ReentrancyMock extends BaseContract {
  ...
  unguardedMethodThatShouldFail: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "unguardedMethodThatShouldFail"
  ): TypedContractMethod<[], [void], "nonpayable">;
