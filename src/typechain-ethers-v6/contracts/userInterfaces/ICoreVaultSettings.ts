...
export interface ICoreVaultSettingsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getCoreVaultManager"
...
export interface ICoreVaultSettings extends BaseContract {
  connect(runner?: ContractRunner | null): ICoreVaultSettings;
  waitForDeployment(): Promise<this>;

  interface: ICoreVaultSettingsInterface;
