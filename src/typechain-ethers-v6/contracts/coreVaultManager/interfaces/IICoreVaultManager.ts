...
export interface IICoreVaultManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "assetManager"
      | "availableFunds"
...
export interface IICoreVaultManager extends BaseContract {
  connect(runner?: ContractRunner | null): IICoreVaultManager;
  waitForDeployment(): Promise<this>;

  interface: IICoreVaultManagerInterface;
