...
export namespace PaymentConfirmedEvent {
  export type InputTuple = [transactionId: BytesLike, amount: BigNumberish];
  export type OutputTuple = [transactionId: string, amount: bigint];
  export interface OutputObject {
...
export interface CoreVaultManager extends BaseContract {
  ...
  confirmPayment: TypedContractMethod<
    [_transactionId: BytesLike, _receivedAmount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "PaymentConfirmed(bytes32,uint256)": TypedContractEvent<
      PaymentConfirmedEvent.InputTuple,
      PaymentConfirmedEvent.OutputTuple,
      PaymentConfirmedEvent.OutputObject
    >;
