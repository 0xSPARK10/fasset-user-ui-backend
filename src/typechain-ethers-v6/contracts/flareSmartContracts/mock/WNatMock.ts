...
export interface WNatMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface WNatMock extends BaseContract {
  connect(runner?: ContractRunner | null): WNatMock;
  waitForDeployment(): Promise<this>;

  interface: WNatMockInterface;
  ...
  delegationModeOf: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  totalSupplyAt: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;

  totalVotePower: TypedContractMethod<[], [bigint], "view">;

  totalVotePowerAt: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
