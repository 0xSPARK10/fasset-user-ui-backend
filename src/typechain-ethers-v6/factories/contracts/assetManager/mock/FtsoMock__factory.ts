...
import type {
  FtsoMock,
  FtsoMockInterface,
} from "../../../../contracts/assetManager/mock/FtsoMock";
...
type FtsoMockConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: FtsoMockConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class FtsoMock__factory extends ContractFactory {
  constructor(...args: FtsoMockConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(_symbol, _decimals, overrides || {});
  }
  override deploy(
    _symbol: string,
    _decimals: BigNumberish,
    ...
    return super.deploy(_symbol, _decimals, overrides || {}) as Promise<
      FtsoMock & {
        deploymentTransaction(): ContractTransactionResponse;
      }
    >;
  }
  override connect(runner: ContractRunner | null): FtsoMock__factory {
    return super.connect(runner) as FtsoMock__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): FtsoMockInterface {
    return new Interface(_abi) as FtsoMockInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): FtsoMock {
    return new Contract(address, _abi, runner) as unknown as FtsoMock;
  }
}
