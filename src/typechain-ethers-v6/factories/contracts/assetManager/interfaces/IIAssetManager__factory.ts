...
import type {
  IIAssetManager,
  IIAssetManagerInterface,
} from "../../../../contracts/assetManager/interfaces/IIAssetManager";
...
export class IIAssetManager__factory {
  static readonly abi = _abi;
  static createInterface(): IIAssetManagerInterface {
    return new Interface(_abi) as IIAssetManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IIAssetManager {
    return new Contract(address, _abi, runner) as unknown as IIAssetManager;
  }
}
