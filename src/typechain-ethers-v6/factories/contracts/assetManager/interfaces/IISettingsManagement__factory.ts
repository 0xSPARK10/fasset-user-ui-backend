...
import type {
  IISettingsManagement,
  IISettingsManagementInterface,
} from "../../../../contracts/assetManager/interfaces/IISettingsManagement";
...
export class IISettingsManagement__factory {
  static readonly abi = _abi;
  static createInterface(): IISettingsManagementInterface {
    return new Interface(_abi) as IISettingsManagementInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IISettingsManagement;
  }
}
