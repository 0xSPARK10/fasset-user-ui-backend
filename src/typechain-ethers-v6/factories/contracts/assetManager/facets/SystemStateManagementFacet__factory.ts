...
import type {
  ...
  SystemStateManagementFacetInterface,
} from "../../../../contracts/assetManager/facets/SystemStateManagementFacet";
...
const _bytecode =
  "";

type SystemStateManagementFacetConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: SystemStateManagementFacetConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class SystemStateManagementFacet__factory extends ContractFactory {
  constructor(...args: SystemStateManagementFacetConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  ): SystemStateManagementFacet__factory {
    return super.connect(runner) as SystemStateManagementFacet__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SystemStateManagementFacetInterface {
    return new Interface(_abi) as SystemStateManagementFacetInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as SystemStateManagementFacet;
  }
}
