...
import type {
  ...
  GovernedProxyImplementationInterface,
} from "../../../../contracts/governance/implementation/GovernedProxyImplementation";
...
export class GovernedProxyImplementation__factory {
  static readonly abi = _abi;
  static createInterface(): GovernedProxyImplementationInterface {
    return new Interface(_abi) as GovernedProxyImplementationInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as GovernedProxyImplementation;
  }
}
