...
import type {
  ...
  GovernedUUPSProxyImplementationInterface,
} from "../../../../contracts/governance/implementation/GovernedUUPSProxyImplementation";
...
export class GovernedUUPSProxyImplementation__factory {
  static readonly abi = _abi;
  static createInterface(): GovernedUUPSProxyImplementationInterface {
    return new Interface(_abi) as GovernedUUPSProxyImplementationInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as GovernedUUPSProxyImplementation;
  }
}
