...
import type {
  Governed,
  GovernedInterface,
} from "../../../../contracts/governance/implementation/Governed";
...
export class Governed__factory {
  ...
  static createInterface(): GovernedInterface {
    return new Interface(_abi) as GovernedInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Governed {
    return new Contract(address, _abi, runner) as unknown as Governed;
  }
}
