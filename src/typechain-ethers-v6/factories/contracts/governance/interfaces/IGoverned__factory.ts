...
import type {
  IGoverned,
  IGovernedInterface,
} from "../../../../contracts/governance/interfaces/IGoverned";
...
export class IGoverned__factory {
  static readonly abi = _abi;
  static createInterface(): IGovernedInterface {
    return new Interface(_abi) as IGovernedInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IGoverned {
    return new Contract(address, _abi, runner) as unknown as IGoverned;
  }
}
