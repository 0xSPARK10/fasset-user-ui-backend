...
import type {
  IICoreVaultManager,
  IICoreVaultManagerInterface,
} from "../../../../contracts/coreVaultManager/interfaces/IICoreVaultManager";
...
export class IICoreVaultManager__factory {
  static readonly abi = _abi;
  static createInterface(): IICoreVaultManagerInterface {
    return new Interface(_abi) as IICoreVaultManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IICoreVaultManager {
    return new Contract(address, _abi, runner) as unknown as IICoreVaultManager;
  }
}
