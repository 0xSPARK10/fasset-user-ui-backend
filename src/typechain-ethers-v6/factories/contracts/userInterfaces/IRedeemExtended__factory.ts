...
import type {
  IRedeemExtended,
  IRedeemExtendedInterface,
} from "../../../contracts/userInterfaces/IRedeemExtended";
...
export class IRedeemExtended__factory {
  static readonly abi = _abi;
  static createInterface(): IRedeemExtendedInterface {
    return new Interface(_abi) as IRedeemExtendedInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IRedeemExtended {
    return new Contract(address, _abi, runner) as unknown as IRedeemExtended;
  }
}
