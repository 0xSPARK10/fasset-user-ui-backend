...
import type {
  ...
  IDirectMintingSettingsInterface,
} from "../../../contracts/userInterfaces/IDirectMintingSettings";
...
export class IDirectMintingSettings__factory {
  static readonly abi = _abi;
  static createInterface(): IDirectMintingSettingsInterface {
    return new Interface(_abi) as IDirectMintingSettingsInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IDirectMintingSettings;
  }
}
