...
import type {
  ITransferFees,
  ITransferFeesInterface,
} from "../../../contracts/userInterfaces/ITransferFees";
...
export class ITransferFees__factory {
  static readonly abi = _abi;
  static createInterface(): ITransferFeesInterface {
    return new Interface(_abi) as ITransferFeesInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ITransferFees {
    return new Contract(address, _abi, runner) as unknown as ITransferFees;
  }
}
