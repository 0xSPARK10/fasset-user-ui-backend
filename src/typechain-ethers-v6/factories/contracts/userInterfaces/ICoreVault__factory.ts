...
import type {
  ICoreVault,
  ICoreVaultInterface,
} from "../../../contracts/userInterfaces/ICoreVault";
...
export class ICoreVault__factory {
  static readonly abi = _abi;
  static createInterface(): ICoreVaultInterface {
    return new Interface(_abi) as ICoreVaultInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ICoreVault {
    return new Contract(address, _abi, runner) as unknown as ICoreVault;
  }
}
