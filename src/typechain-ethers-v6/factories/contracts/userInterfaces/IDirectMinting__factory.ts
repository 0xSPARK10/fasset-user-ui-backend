...
import type {
  IDirectMinting,
  IDirectMintingInterface,
} from "../../../contracts/userInterfaces/IDirectMinting";
...
export class IDirectMinting__factory {
  static readonly abi = _abi;
  static createInterface(): IDirectMintingInterface {
    return new Interface(_abi) as IDirectMintingInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IDirectMinting {
    return new Contract(address, _abi, runner) as unknown as IDirectMinting;
  }
}
